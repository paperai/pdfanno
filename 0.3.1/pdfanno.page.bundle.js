...
class PDFAnnoPage {
    ...
    createSpan ({ text = null, color = null } = {}) {
        ...
        const highlight = __WEBPACK_IMPORTED_MODULE_3__search__["a" /* getSearchHighlight */]()
        ...
        if (!rects && !highlight && selectedAnnotations.length === 0) {
            return __WEBPACK_IMPORTED_MODULE_1_anno_ui__["ui"].alertDialog.show({ message : 'Select text span or an annotation.' })
        }
        ...
        if (selectedAnnotations.length > 0) {
            ...
            __WEBPACK_IMPORTED_MODULE_5__shared_util__["b" /* dispatchWindowEvent */]('disappearTextInput')
