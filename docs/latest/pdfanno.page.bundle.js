...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_annoRectButton__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_annoRelButton__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_annoSpanButton__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_labelInput__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__behavior__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__page_pdftxtdownload__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__page_socket__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__page_pdf_PDFAnnoPage__ = __webpack_require__(45);
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    // Node
    module.exports = factory(__webpack_require__(15), __webpack_require__(16), __webpack_require__(17));
  } else if (true) {
    // AMD. Register as an anonymous module.
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(15), __webpack_require__(16), __webpack_require__(17)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
...
function addAllAnnotations (tomlObject) {
    ...
    for (const key in tomlObject) {
        ...
        data.id = key
        data.uuid = __WEBPACK_IMPORTED_MODULE_0_anno_ui_src_utils__["a" /* uuid */]()
...
class PublicRectAnnotation {
    ...
    constructor ({ page, position, label = '', id = 0, uuid = '' }) {
        ...
        let rect = window.annoPage.createRectAnnotation({
            uuid,
            x        : position[0],
            y        : __WEBPACK_IMPORTED_MODULE_2__shared_coords__["a" /* convertFromExportY */](page, position[1]),
            width    : position[2],
            height   : position[3],
            text     : label,
            color    : '#FF0',
    ...
    constructor ({ page, position, label = '', text = '', id = 0, uuid = '', zIndex = 10, textrange = [], color = null }) {
        ...
        position = position.map(p => {
            return {
                page   : page,
                x      : p[0],
                y      : __WEBPACK_IMPORTED_MODULE_2__shared_coords__["a" /* convertFromExportY */](page, p[1]),
                width  : p[2],
                height : p[3]
            }
        })
