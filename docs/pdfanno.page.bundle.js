...
/***/ function(module, exports, __webpack_require__) {
	...
	var _browseButton = __webpack_require__(48);
	...
	*/
	 ...
	 */
	window.annoPage = new _PDFAnnoPage2.default();
	...
	$(document).on('keydown', function (e) {
	    ...
	    if (e.keyCode === 49) {
	        // Digit "1"
	        (0, _util.dispatchWindowEvent)('digit1Pressed');
	    } else if (e.keyCode === 50) {
	        // Digit "2"
	        (0, _util.dispatchWindowEvent)('digit2Pressed');
	    } else if (e.keyCode === 51) {
	        // Digit "3"
	        (0, _util.dispatchWindowEvent)('digit3Pressed');
	    } else if (e.keyCode === 52) {
	        // Digit "4"
	        (0, _util.dispatchWindowEvent)('digit4Pressed');
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setup() {
	    ...
	    $('.js-file :file').on('change', function (ev) {
	        ...
	        window.annoPage.loadFiles(files).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setup() {
	    ...
	    $('#dropdownAnnoList').on('click', function () {
	        ...
	        var annotations = window.annoPage.getAllAnnotations();
	    ...
	    $('#dropdownAnnoList').on('click', 'a', function (e) {
	        ...
	        var annotation = window.annoPage.findAnnotationById(id);
	        ...
	        if (annotation) {
	            ...
	            var pageHeight = window.annoPage.getViewerViewport().height;
	            var scale = window.annoPage.getViewerViewport().scale;
	    ...
	    function watchPrimaryAnno(e) {
	        var primaryAnnos = window.annoPage.getAllAnnotations().filter(function (a) {
	            return !a.readOnly;
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _getDownloadFileName() {
	    ...
	    // The name of PDF.
	    var pdfFileName = window.annoPage.getCurrentContentName();
...
/***/ function(module, exports) {
	...
	exports.adjustViewerSize = adjustViewerSize;
...
/***/ function(module, exports) {
	...
	function setup() {
	    $('.js-btn-upload').off('click').on('click', function () {
	        ...
	        var conentFile = window.annoPage.getContentFile(pdfFileName);
	        ...
	        var contentBase64 = arrayBufferToBase64(conentFile.content);
...
/***/ function(module, exports) {
	...
	function saveText(uuid) {
	    ...
	    var annotation = window.annoPage.findAnnotationById(uuid);
	    if (annotation) {
	...
	function listenWindowEvents() {
	    ...
	    window.addEventListener('annotationDeleted', function (e) {
	        treatAnnotationDeleted(e.detail);
	    });
	
	    // handle annotation hoverIn.
	    window.addEventListener('annotationHoverIn', function (e) {
	        handleAnnotationHoverIn(e.detail);
	    });
	
	    // handle annotation hoverOut.
	    window.addEventListener('annotationHoverOut', function (e) {
	        handleAnnotationHoverOut(e.detail);
	    });
	
	    // handle annotation selected.
	    window.addEventListener('annotationSelected', function (e) {
	        handleAnnotationSelected(e.detail);
	    });
	
	    // handle annotation deselected.
	    window.addEventListener('annotationDeselected', function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PublicRectAnnotation = function PublicRectAnnotation(_ref) {
	    ...
	    var rect = window.annoPage.createRectAnnotation({
	...
	var PublicSpanAnnotation = exports.PublicSpanAnnotation = function PublicSpanAnnotation(_ref2) {
	    ...
	    var span = window.annoPage.createSpanAnnotation({
	        uuid: id && String(id), // annotationid must be string.
	        rectangles: position,
	        text: label,
	...
	var PublicRelationAnnotation = exports.PublicRelationAnnotation = function PublicRelationAnnotation(_ref3) {
	    ...
	    var r = window.annoPage.createRelationAnnotation({
	        uuid: id && String(id), // annotationid must be string.
	        direction: dir,
	    ...
	    _createClass(PDFAnnoPage, [{
	        ...
	        value: function startViewerApplication() {
	            ...
	            iframeWindow.addEventListener('annotationUpdated', function () {
	                ...
	                (0, _util.dispatchWindowEvent)('annotationUpdated');
	            });
	
	            // enable text input.
	            iframeWindow.addEventListener('enableTextInput', function (e) {
	                (0, _util.dispatchWindowEvent)('enableTextInput', e.detail);
	            });
	
	            // disable text input.
	            iframeWindow.addEventListener('disappearTextInput', function () {
	                (0, _util.dispatchWindowEvent)('disappearTextInput', e.detail);
	            });
	
	            iframeWindow.addEventListener('annotationDeleted', function (e) {
	                (0, _util.dispatchWindowEvent)('annotationDeleted', e.detail);
	            });
	
	            iframeWindow.addEventListener('annotationHoverIn', function (e) {
	                (0, _util.dispatchWindowEvent)('annotationHoverIn', e.detail);
	            });
	
	            iframeWindow.addEventListener('annotationHoverOut', function (e) {
	                (0, _util.dispatchWindowEvent)('annotationHoverOut', e.detail);
	            });
	
	            iframeWindow.addEventListener('annotationSelected', function (e) {
	                (0, _util.dispatchWindowEvent)('annotationSelected', e.detail);
	            });
	
	            iframeWindow.addEventListener('annotationDeselected', function () {
	                (0, _util.dispatchWindowEvent)('annotationDeselected');
	            });
	        ...
	        key: 'getContentFile',
	        value: function getContentFile(name) {
	            var items = this.contentFiles.filter(function (c) {
	                return c.name === name;
	            });
	            if (items.length > 0) {
	                return items[0];
	        ...
	        key: 'getAnnoFile',
	        value: function getAnnoFile(name) {
	            var items = this.annoFiles.filter(function (c) {
	                return c.name === name;
	            });
	            if (items.length > 0) {
	                return items[0];
	        ...
	        key: 'displayContent',
	        value: function displayContent(contentName) {
	
	            var contentFile = this.contentFiles.filter(function (c) {
	                return c.name === contentName;
	            });
	        ...
	        key: 'displayViewer',
	        value: function displayViewer(contentFile) {
	
	            // Reset settings.
	            this.resetPDFViewerSettings();
	
	            // Load PDF.
	            var uint8Array = new Uint8Array(contentFile.content);
	        ...
	        key: 'resetPDFViewerSettings',
	        value: function resetPDFViewerSettings() {
	        ...
	        key: 'createRelation',
	        value: function createRelation(type) {
	        ...
	        */
	        ...
	        key: 'enableAnnotateFunction',
	        value: function enableAnnotateFunction(type) {
	            if (type === 'rect') {
	                window.iframeWindow.PDFAnnoCore.UI.enableRect();
	            }
	        }
	        ...
	        value: function findAnnotationById(id) {
	        ...
	        value: function clearAllAnnotations() {
	        ...
	        key: 'createRectAnnotation',
	        value: function createRectAnnotation(options) {
	        ...
	        key: 'createSpanAnnotation',
	        value: function createSpanAnnotation(options) {
	        ...
	        key: 'createRelationAnnotation',
	        value: function createRelationAnnotation(options) {
	        ...
	        key: 'getViewerViewport',
	        value: function getViewerViewport() {
	        ...
	        key: 'getCurrentContentName',
	        value: function getCurrentContentName() {
	        ...
	        key: 'manageCtrlKey',
	        value: function manageCtrlKey(type) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadFiles(files) {
	    var _getContents = getContents(files),
	        pdfNames = _getContents.pdfNames,
	        annoNames = _getContents.annoNames;
	    ...
	    return new Promise(function (resolve, reject) {
	        ...
	        Promise.all(promises).then(function (results) {
	            ...
	            var contents = results.filter(function (r) {
	                return r.type === 'content';
	            });
	            var annos = results.filter(function (r) {
	                return r.type === 'anno';
	            });
	
	            resolve({ contents: contents, annos: annos });
	        });
	    });
	}
